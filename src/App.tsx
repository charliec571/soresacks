...
import { DiscGolfMiniGame } from './components/DiscGolfMiniGame';
...
export const App: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-md mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-1.5 rounded-xl border ${activeThemeConfig.borderClass} ${activeThemeConfig.cardClass} hover:bg-amber-400/20 text-amber-400 flex items-center justify-center transition-all active:scale-90 shadow-sm`}
              title="Play Backyard Chains Mini-Game"
            >
              <GamepadIcon size={16} />
            </button>
      ...
      {isMiniGameOpen && (
        <DiscGolfMiniGame onClose={() => setIsMiniGameOpen(false)} />
      )}
